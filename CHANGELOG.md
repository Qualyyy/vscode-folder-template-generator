...
## [Unreleased]
### Fixed
- A casetype in a filename should no longer give an error


## [1.2.0] - 2026-01-26
### Added
- **Case types**:
  - Variables in templates and fileNames now support case types.
...
- Extension icon updated to cropped transparent version and without text.
